  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Discover the latest tips and strategies to get the most out of your solar energy system and reduce your energy bills. Learn about panel positioning, maintenance, and optimizing your system for maximum output.",
    ...
    },
    {
      ...
      excerpt:
        "Learn how battery storage can help you store excess solar energy and become more energy independent. We break down the benefits, costs, and considerations for UK homeowners.",
      date: "October 8, 2025",
      category: "Technology",
    ...
    },
    {
      ...
      excerpt:
        "Everything you need to know about solar panel installation costs, government incentives, and long-term savings. Make an informed decision about your solar investment.",
      date: "October 1, 2025",
      category: "Finance",
    ...
    },
    {
      ...
      excerpt:
        "Stay up-to-date with the latest government grants, feed-in tariffs, and incentives available for UK homeowners installing solar panels.",
    ...
    },
    {
      ...
      excerpt:
        "Thinking about installing an EV charger at home? Learn about the different types, installation requirements, and how to combine it with your solar system.",
    ...
    },
    {
      ...
      excerpt:
        "Regular maintenance is key to keeping your solar panels performing at their best. Here's everything you need to know about solar panel maintenance.",
          ...
          <ScrollAnimation animation="fadeInUp" delay={0}>
            <div className="blog-header-content">
              ...
              <h1 className="blog-header-title">
                <span className="blog-title-main">
                  <BrandName />
                </span>
                <span className="blog-title-subtitle">Insights Hub</span>
              </h1>
              <p className="blog-header-tagline">
                Stay informed with the latest insights, research, and
                innovations in solar energy technology. Discover how renewable
                energy is transforming UK homes for a more sustainable future.
              </p>
            </div>
          </ScrollAnimation>
        </div>
        ...
        <div className="blog-latest-section">
          <div className="blog-section-header">
            <div>
              ...
              <p className="blog-articles-count">
                {searchedPosts.length} articles found
              </p>
            </div>
          </div>
                      ...
                      <div className="blog-post-footer">
                        ...
                        <div className="blog-post-footer-right">
                          <div className="blog-post-tags">
                            <span className="blog-tag-small">
                              {post.tags[0]}
                            </span>
                            {post.tags.length > 1 && (
                              <span className="blog-tag-count">
                                +{post.tags.length - 1}
                              </span>
                            )}
                          </div>
