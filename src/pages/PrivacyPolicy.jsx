          ...
          <ScrollAnimation animation="fadeInUp" delay={200}>
            ...
            <section className="legal-section">
              ...
              <ul>
                ...
                <li><strong>Website Improvement:</strong> To analyse website usage and improve user experience</li>
            ...
            <section className="legal-section">
              ...
              <p>
                We implement appropriate technical and organisational measures to protect your personal information against unauthorised access, alteration, disclosure, or destruction. Your data is stored on secure servers within the UK. However, no method of transmission over the internet is 100% secure.
              </p>
            </section>
            ...
            <section className="legal-section">
              ...
              <p>
                We retain your personal information only for as long as necessary to fulfil the purposes outlined in this policy, unless a longer retention period is required by law. Typically:
              </p>
              <ul>
                <li><strong>Contact Form Submissions:</strong> 12 months. Long enough to respond and follow up, often aligned with customer service or business development cycles. Some companies shorten this to 12 months unless there's an ongoing relationship.</li>
                <li><strong>Marketing Leads / Newsletter Signups:</strong> 12–24 months of inactivity, or sooner if requested. We will delete your data earlier if you ask us to.</li>
            ...
            <section className="legal-section">
              ...
              <p>
                We use cookies and similar technologies to enhance your browsing experience and analyse website traffic. For detailed information about our use of cookies, please see our <a href="/cookies">Cookie Policy</a>.
              </p>
            </section>
